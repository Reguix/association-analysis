...
ForceAtlas2.prototype.initNodes = function(positionArr, massArr, sizeArr) {
...
ForceAtlas2.prototype.updateSettings = function() {
    // 0.1 under 5000 nodes, 1 up to 50000 nodes and 10 above
...
ForceAtlas2.prototype.update = function() {
    var nNodes = this.nodes.length;
...
ForceAtlas2.prototype.applyRegionToNodeRepulsion = (function() {
    var v = vec2.create();
...
ForceAtlas2.prototype.applyNodeToNodeRepulsion = (function() {
    var v = vec2.create();
...
ForceAtlas2.prototype.applyEdgeAttraction = (function() {
    var v = vec2.create();
...
ForceAtlas2.prototype.applyNodeGravity = (function() {
    var v = vec2.create();
...
ForceAtlas2.prototype.applyNodeStrongGravity = (function() {
    var v = vec2.create();
    return function(node) {
        vec2.negate(v, node.position);
...
ForceAtlas2.prototype.updateBBox = function() {
    var minX = Infinity;
    var minY = Infinity;
    var maxX = -Infinity;
    var maxY = -Infinity;
